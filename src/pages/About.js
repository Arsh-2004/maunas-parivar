            ...
            <div className="history-text">
              ...
              <p>
                {language === 'en'
                  ...
                  : 'क्षत्रिय मौनस वंश का एक गौरवशाली और प्रतिष्ठित इतिहास है जो सदियों पुरानी परंपराओं में निहित है। वीरता, प्रशासनिक कौशल और धर्म की रक्षा के लिए समर्पण के लिए जाने जाते हैं, मौनस क्षत्रियों ने भारतीय इतिहास में विभिन्न राज्यों और क्षेत्रों में महत्वपूर्ण भूमिका निभाई है।'}
              </p>
              <p>
                {language === 'en'
                  ...
                  : 'हमारे पूर्वज प्रसिद्ध योद्धा, प्रशासक और अपने लोगों के रक्षक थे। उन्होंने सम्मान, कर्तव्य और सेवा के सर्वोच्च मानदंड को बनाए रखा। मौनस क्षत्रिय वंश ने भारतीय सांस्कृतिक और सामाजिक संरचना में महत्वपूर्ण योगदान दिया है।'}
              </p>
              <p>
                {language === 'en'
                  ...
                  : 'आज, जबकि हम इन परंपराओं को सम्मानित करते हैं, हमारा वंश आधुनिक शिक्षा, व्यवसाय और विभिन्न व्यावसायिक क्षेत्रों को अपनाने के लिए प्रतिबद्ध है।'}
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="values-grid">
            ...
            <div className="value-card">
              ...
              <p>{language === 'en' ? 'Serve our community and society' : 'अपने वंश और समाज की सेवा करना'}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="message-content">
            <div className="president-image">
              ...
              <p>{language === 'en' ? 'Ravindra Kumar Singh' : 'रविंद्र कुमार सिंह'}</p>
            </div>
            <div className="message-text">
              ...
              <p>
                {language === 'en'
                  ...
                  : 'इन आधुनिक समय में, जबकि हम अपने गौरवशाली अतीत को सम्मानित करते हैं, हमें प्रगति और एकता को भी अपनाना चाहिए। हमारा उद्देश्य यह सुनिश्चित करना है कि हमारे वंश के हर सदस्य को विकास, शिक्षा और समृद्धि के अवसर मिलें।'}
              </p>
              <p>
                {language === 'en'
                  ...
                  : 'मैं अपने परिवार के प्रत्येक सदस्य को, क्षत्रिय मौनस परिवार के पहलों, कार्यक्रमों और संचालन में सक्रिय रूप से भाग लेने के लिए आमंत्रित करता हूं। हम एक साथ मिलकर अपने बंधनों को मजबूत कर सकते हैं और अपने वंश को एक बेहतर भविष्य की ओर ले जा सकते हैं।'}
              </p>
