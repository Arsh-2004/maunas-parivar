    ...
    <div className="about-page">
      ...
      <section className="page-header">
        <div className="container">
          <h1>{language === 'en' ? 'About Kshatriya Maunas Parivar' : 'क्षत्रिय मौना परिवार के बारे में'}</h1>
        ...
        <div className="container">
          ...
          <div className="history-content">
            <div className="history-text">
              <h3>{language === 'en' ? 'Maunas Kshatriya Traditions' : 'मौना क्षत्रियों की परंपरा'}</h3>
              <p>
                {language === 'en'
