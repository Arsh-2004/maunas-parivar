            ...
            <div className="about-text">
              <p>
                {language === 'en' 
                  ...
                  : 'क्षत्रिय मौनस परिवार, क्षत्रिय समुदाय की समृद्ध विरासत और परंपराओं को संरक्षित करने के लिए समर्पित है। हम विभिन्न सामाजिक, सांस्कृतिक और शैक्षिक क्रियाकलापों के माध्यम से एकता को बढ़ावा देने, सहायता प्रदान करने और अपने सदस्यों को सशक्त बनाने के लिए प्रतिबद्ध हैं।'
                }
              </p>
              <p>
                {language === 'en'
                  ...
                  : 'हमारा मिशन क्षत्रियों का एक मजबूत नेटवर्क बनाना है जो अपने समुदाय के कल्याण के लिए एक साथ काम करते हैं, तथा अपने पूर्वजों का सम्मान करते हैं और साहस, सम्मान एवं ईमानदारी के अपने मूल्यों को बनाए रखते हैं।'
                }
              </p>
        ...
        <div className="container">
          ...
          <div className="objectives-grid">
            ...
            <div className="objective-card">
              ...
              <p>{language === 'en' ? 'Empower members through networking and collaborative opportunities' : 'आपसी भाईचारा और सहयोगी अवसरों के माध्यम से सदस्यों को सशक्त बनाना'}</p>
            </div>
          </div>
        </div>
      </section>
